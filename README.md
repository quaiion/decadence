...
|:-:|:-|:-|:-|
| PATTERN | Used to switch a universal single-bunch model (scripts/decadence.py) between "single-random-bunch" and "single-dense-bunch" modes | **'single_dense'** or **'single_rand'** | universal single-bunch model |
